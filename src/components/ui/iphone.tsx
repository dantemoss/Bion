...
export function Iphone({
  ...
  const hasCustomContent = !!children && !hasVideo && !src
  ...
  return (
    ...
    >
      ...
      {hasCustomContent && (
        <div
          className="pointer-events-none absolute z-0 flex items-center justify-center overflow-hidden bg-zinc-950 text-center"
          style={{
            left: `${LEFT_PCT}%`,
            top: `${TOP_PCT}%`,
            width: `${WIDTH_PCT}%`,
